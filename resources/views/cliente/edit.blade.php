        ...
        <div class="card-body">
            <form method="POST" action="{{ route('cliente.update', $cliente->id) }}">
                ...
                <div class="form-group col-md-6 my-3">
                    ...
                    <input name="ci" type="text" class="form-control" value="{{ old('ci', $cliente->ci) }}"
                        id="ci">
                    @error('ci')
                        <small>{{ $message }}</small>
                        <br><br>
                ...
                <div class="form-group col-md-6 my-3">
                    ...
                    <input name="correo" type="email" class="form-control" value="{{ old('correo', $cliente->correo) }}"
                        id="correo">
                    @error('correo')
                        <small>{{ $message }}</small>
                        <br><br>
                ...
                <div class="form-group col-md-6 my-3">
                    ...
                    <input name="lugar_nac" type="text" class="form-control" value="{{ old('lugar_nac', $cliente->lugar_nac) }}"
                        id="lugar_nac">
                    @error('lugar_nac')
                        <small>{{ $message }}</small>
                        <br><br>
                ...
                <div class="form-group col-md-6 my-3">
                    ...
                    <input name="fecha_nac" type="date" class="form-control" value="{{ old('fecha_nac', $cliente->fecha_nac) }}"
                        id="fecha_nac">
                    @error('fecha_nac')
                        <small>{{ $message }}</small>
                        <br><br>
                ...
                <div class="form-group col-md-6 my-3">
                    ...
                    <input name="hijos" type="number" class="form-control" value="{{ old('hijos', $cliente->hijos) }}"
                        id="hijos">
                    @error('hijos')
                        <small>{{ $message }}</small>
                        <br><br>
                ...
                <div class="form-group col-md-6 my-3">
                    ...
                    <input name="nacionalidad" type="text" class="form-control" value="{{ old('nacionalidad', $cliente->nacionalidad) }}"
                        id="nacionalidad">
                    @error('nacionalidad')
                        <small>{{ $message }}</small>
                        <br><br>
                ...
                <div class="form-group col-md-6 my-3">
                    ...
                    <select name="nivel_educacion" class="form-control col-md-6" id="nivel_educacion">
                            <option value="{{$cliente->nivel_educacion}}">{{$cliente->nivel_educacion}}</option>
                ...
                <div class="form-group col-md-6 my-3">
                    ...
                    <input name="direccion_domicilio" type="text" class="form-control" value="{{ old('direccion_domicilio', $cliente->direccion_domicilio) }}"
                ...
                <div class="form-group col-md-6 my-3">
                    ...
                    <select name="tipo_tenencia_dom" class="form-control col-md-6" id="tipo_tenencia_dom">
                        <option value="{{$cliente->tipo_tenencia_dom}}">{{$cliente->tipo_tenencia_dom}}</option>
                ...
                <div class="form-group col-md-6 my-3">
                    ...
                    <input name="direccion_trabajo" type="text" class="form-control" value="{{ old('direccion_trabajo', $cliente->direccion_trabajo) }}"
                ...
                <div class="form-group col-md-6 my-3">
                    ...
                    <select name="tipo_tenencia_trab" class="form-control col-md-6" id="tipo_tenencia_trab">
                        <option value="{{$cliente->tipo_tenencia_trab}}">{{$cliente->tipo_tenencia_trab}}</option>
                ...
                <div class="form-group col-md-6 my-3">
                    ...
                    <input name="ingreso_prom_mensual" type="text" class="form-control" value="{{ old('ingreso_prom_mensual', $cliente->ingreso_prom_mensual) }}"
